...
var Template = function () {
    ...
    _createClass(Template, null, [{
            ...
            return new Promise(function (done) {
                Object.keys(layouts).forEach(function (layout) {
                    languages.forEach(function (language) {
                        return layouts[layout].i18n[language] = {
                            component: {},
                            module: {}
                        };
                    });
                    _fs2.default.readdirSync(componentsDir).forEach(function (component) {
                        var componentDir = _path2.default.join(componentsDir, component);
                        if (_fs2.default.statSync(componentDir).isDirectory()) languages.forEach(function (language) {
                            var languageFile = _path2.default.join(componentDir, 'locale', language + '.json');
                            if (_fs2.default.existsSync(languageFile)) layouts[layout].i18n[language].component[component] = require(languageFile);
                        });
                    });
                    if (modulesDir) _fs2.default.readdirSync(modulesDir).forEach(function (module) {
                        var moduleDir = _path2.default.join(modulesDir, module);
                        if (_fs2.default.statSync(moduleDir).isDirectory()) languages.forEach(function (language) {
                            var languageFile = _path2.default.join(moduleDir, 'locale', language + '.json');
                            if (_fs2.default.existsSync(languageFile)) layouts[layout].i18n[language].module[module] = require(languageFile);
                        });
                    });
                });
                done(layouts);
        ...
        key: 'loadLocalesFromSource',
        value: function loadLocalesFromSource(componentsDir) {
            var modulesDir = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
                ...
                Object.keys(layouts).forEach(function (layout) {
                    ...
                    _fs2.default.readdirSync(componentsDir).forEach(function (component) {
                        ...
                        if (_fs2.default.statSync(componentDir).isDirectory()) {
                            ...
                            if (_fs2.default.existsSync(componentFile)) layouts[layout].i18n[language].component[component] = require(componentFile).default;
                        }
                    });
                    if (modulesDir) _fs2.default.readdirSync(modulesDir).forEach(function (module) {
                        var moduleDir = _path2.default.join(modulesDir, module);
                        if (_fs2.default.statSync(moduleDir).isDirectory()) {
                            var moduleFile = _path2.default.join(moduleDir, 'locale', 'source.js');
                            if (_fs2.default.existsSync(moduleFile)) layouts[layout].i18n[language].module[module] = require(moduleFile).default;
                        }
                    });
                });
                done(layouts);
